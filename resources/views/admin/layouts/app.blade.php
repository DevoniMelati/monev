...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title>E Monev Padang Panjang</title>
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li>
							<a href="/admin/aplikasi" class="dropdown-toggle no-arrow @if ($activePage == 'aplikasi') active @endif">
								<span class="micon dw dw-notepad-2"></span><span class="mtext">Data Aplikasi</span>
							</a>
						</li>
					</ul>
				</div>
		...
		<div class="main-container">
			<div class="pd-ltr-20">
				...
				<div class="footer-wrap pd-20 mb-20 card-box">
					E Monev Padang Panjang - Copyright © {{date('Y')}}
					<a href="https://diskominfo.padangpanjang.go.id" style="text-decoration: none" target="_blank"
						>Kominfo Theme</a
					>
				</div>
			</div>
